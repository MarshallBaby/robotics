...
<div class="header">
      ...
      <ul class="header__menu">
        <li class="header__menu__item header__menu__dropdown"> О нас <i class="fas fa-caret-down"></i>
          <section class="display-none">
            <ul>
              <li class="header__menu__dropdown__item">  <a href="#">  Лаборатория работотехники  </a> </li>
              <li class="header__menu__dropdown__item"> <a href="#"> Команда  </a></li>
              <li class="header__menu__dropdown__item"> <a href="#"> История  </a></li>
            </ul>
          </section>
         </li>
      ...
      <ul class="header__submenu">
       <div class="header__submenu__menu"> <i class="fas fa-bars"></i> </div>
        <li class="header__submenu__item"> <a href="#"> Wiki </a> </li>
      </ul>
</div>